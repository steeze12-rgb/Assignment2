...
class QuizActivity : AppCompatActivity() {
    ...
    val explanations = arrayOf(
        "Hack: Background apps can consume power, especially if actively updating",
        "Hack: Airplane mode reduces network usage, allowing faster charging",
        "Hack: OLED screens use less power with dark pixels",
        "Myth: Modern systems manage RAM efficiently on their own",
        "Myth: Public Wi-Fi can expose your data to security risks"
    )
